...
public class NewProduct extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==b1) {
			int q;
			double pr;
			if(Product.getIndex(t3.getText())==-1) {
				try {
					...
					pr = Double.parseDouble(t2.getText());
						...
						JOptionPane.showMessageDialog(null, "The Product "+p.getName()+" Added Successfully");
						t3.setText("");
						t4.setText("");
						t2.setText("");
						a4.setText("");
				...
				JOptionPane.showMessageDialog(null, "This Name Already Founded","",0);
				t3.setText("");
			}
		}
